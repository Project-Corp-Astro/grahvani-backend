...
export class HistoryService {
    ...
    async addConsultation(tenantId: string, clientId: string, data: any, metadata: RequestMetadata) {
        ...
        await activityService.recordActivity({
            ...
            details: { consultationId: consultation.id, type: consultation.consultationType },
        ...
        await eventPublisher.publish('client.consultation_added', {
            clientId,
            tenantId,
            data: { consultationId: consultation.id, type: consultation.consultationType },
            metadata: {
                ipAddress: metadata.ipAddress,
                userAgent: metadata.userAgent,
                deviceType: metadata.deviceType,
        ...
        logger.info({ tenantId, clientId, consultationId: consultation.id }, 'Consultation history added');
