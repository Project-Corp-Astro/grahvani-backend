...
export function compressChartData(data: any): any {
    ...
    try {
        ...
        if (compressionRatio > 0.8) {
            logger.debug({ originalSize, compressedSize, ratio: compressionRatio },
 ...
 */
export function getCompressionStats(data: any): { isCompressed: boolean; originalSize?: number; compressedSize?: number; savings?: string } {
