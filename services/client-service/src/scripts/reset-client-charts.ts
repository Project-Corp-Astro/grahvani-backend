...
async function resetClientCharts() {
    ...
    try {
        ...
        console.log(`Location: ${client.birthPlace} (${client.birthLatitude}, ${client.birthLongitude})`);
        ...
        console.log('  ✓ D1 Chart Generated (Asc Sign:', d1Response.data?.ascendant?.sign || 'N/A', ')');
        ...
        console.log('  ✓ D9 Chart Generated (Asc Sign:', d9Response.data?.ascendant?.sign || 'N/A', ')');
