...
console.log(`Parent: ${parent.planet}, Start: ${parent.start_date}, Duration: ${parent.duration_years}`);
...
subs.forEach(s => {
    console.log(`  - ${s.planet}: ${s.start_date} -> ${s.end_date} (dur: ${s.duration_years.toFixed(4)})`);
});
