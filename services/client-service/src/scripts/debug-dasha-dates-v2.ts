...
async function debugV2() {
    ...
    if (list1.length > 0) {
        ...
        const res2 = await astroEngineClient.getVimshottariDasha(birthData, 'antardasha', { mahaLord: m.planet });
        const list2 = res2.dasha_list || (res2.data && (res2.data.dasha_list || res2.data.antardashas)) || [];
