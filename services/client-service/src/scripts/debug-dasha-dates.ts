...
async function debugDates() {
  ...
  try {
    ...
    console.log(
      `First Mahadasha: ${firstMaha.planet} (${firstMaha.start_date} to ${firstMaha.end_date})`,
    );
    ...
    if (antardashas.length > 0) {
      if (
        antardashas[0].start_date === firstMaha.start_date &&
        antardashas[antardashas.length - 1].end_date === firstMaha.end_date
      ) {
        console.log(
      ...
      if (
        antardashas[0].start_date === firstMaha.start_date &&
        antardashas[0].end_date === firstMaha.end_date
      ) {
        console.log(
