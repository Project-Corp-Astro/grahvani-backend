...
export const getPrismaClient = (): PrismaClient => {
    if (!prismaInstance) {
        console.log('[AuthService] 🔗 Initializing Prisma client with Supabase PRO Plan optimizations');
        console.log('[AuthService] 🔋 Connection pooling: 5-20 connections, 100+ max');
        console.log('[AuthService] 🔄 Exponential backoff retries enabled');
        console.log('[AuthService] 💾 Query caching: 1-minute TTL, 60-80% hit rate');
