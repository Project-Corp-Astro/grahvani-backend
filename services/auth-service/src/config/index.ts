...
const envSchema = z.object({
  ...
  SUPABASE_URL: z
    .string()
    .default(process.env.NODE_ENV === "test" ? "http://mock-supabase.local" : ""),
  ...
  JWT_REFRESH_SECRET: z
    .string()
    .min(32)
    .default(process.env.NODE_ENV === "test" ? "mock-refresh-secret-at-least-32-chars-long" : ""),
