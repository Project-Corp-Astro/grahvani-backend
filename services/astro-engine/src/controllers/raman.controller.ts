...
export class RamanController {
  ...
  async getArudhaLagna(req: Request, res: Response): Promise<void> {
    await this.handleLagnaChart(req, res, "arudha-lagna", (data) =>
      ramanClient.getArudhaLagna(data),
    );
  }
  ...
  async getSripathiBhava(req: Request, res: Response): Promise<void> {
    await this.handleLagnaChart(req, res, "sripathi-bhava", (data) =>
      ramanClient.getSripathiBhava(data),
    );
  }
  ...
  async getKarkamshaD1(req: Request, res: Response): Promise<void> {
    await this.handleLagnaChart(req, res, "karkamsha-d1", (data) =>
      ramanClient.getKarkamshaD1(data),
    );
  }

  async getKarkamshaD9(req: Request, res: Response): Promise<void> {
    await this.handleLagnaChart(req, res, "karkamsha-d9", (data) =>
      ramanClient.getKarkamshaD9(data),
    );
  }
