...
export class RamanClient extends BaseAstroClient {
  ...
  async getD2Hora(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D2_HORA, data);
  }
  async getD3Drekkana(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D3_DREKKANA, data);
  }
  async getD4Chaturthamsha(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D4_CHATURTHAMSHA, data);
  }
  async getD7Saptamsha(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D7_SAPTAMSHA, data);
  }
  async getD9Navamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D9_NAVAMSA, data);
  }
  async getD10Dasamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D10_DASAMSA, data);
  }
  async getD12Dwadasamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D12_DWADASAMSA, data);
  }
  async getD16Shodasamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D16_SHODASAMSA, data);
  }
  async getD20Vimshamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D20_VIMSHAMSA, data);
  }
  async getD24Chaturvimshamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D24_CHATURVIMSHAMSA, data);
  }
  async getD27Saptavimshamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D27_SAPTAVIMSHAMSA, data);
  }
  async getD30Trimshamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D30_TRIMSHAMSA, data);
  }
  async getD40Khavedamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D40_KHAVEDAMSA, data);
  }
  async getD45Akshavedamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D45_AKSHAVEDAMSA, data);
  }
  async getD60Shashtiamsa(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.D60_SHASHTIAMSA, data);
  }
  ...
  async getArudhaLagna(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.ARUDHA_LAGNA, data);
  }
  async getBhavaLagna(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.BHAVA_LAGNA, data);
  }
  async getHoraLagna(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.HORA_LAGNA, data);
  }
  async getSripathiBhava(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.SRIPATHI_BHAVA, data);
  }
  async getKpBhava(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.KP_BHAVA, data);
  }
  async getEqualBhava(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.EQUAL_BHAVA, data);
  }
  async getKarkamshaD1(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.KARKAMSHA_D1, data);
  }
  async getKarkamshaD9(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.KARKAMSHA_D9, data);
  }
  ...
  async getMahaAntarDasha(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.MAHA_ANTAR_DASHA, data);
  }
  async getPratyantarDasha(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.PRATYANTAR_DASHA, data);
  }
  async getSookshmaDasha(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.SOOKSHMA_DASHA, data);
  }
  async getPranaDasha(data: BirthData) {
    return this.post(RAMAN_ENDPOINTS.PRANA_DASHA, data);
  }
