...
async function verify() {
    ...
    try {
        ...
        // Check for periods
        const periods1 = t1.data.tribhagi_dashas_janma || t1.data.mahadashas || t1.data.ashtottari_dasha || t1.data.ashtottari_antar || [];
        ...
        try {
            ...
            const periods2 = t2.data.mahadashas || t2.data.ashtottari_dasha || t2.data.ashtottari_antar || t2.data.ashtottari_pratyantardasha || [];
                ...
                if (p1.antardashas) {
                    ...
                    for (const subKey of Object.keys(a1)) {
                        if (Array.isArray(a1[subKey])) {
                            console.log(`    FOUND NESTED ARRAY in Antar: '${subKey}' (length ${a1[subKey].length})`);
                        }
                    }
