...
router.post('/choghadiya', panchangaController.getChoghadiya.bind(panchangaController));
router.post('/hora', panchangaController.getHora.bind(panchangaController));
router.post('/lagna', panchangaController.getLagnaTimes.bind(panchangaController));
