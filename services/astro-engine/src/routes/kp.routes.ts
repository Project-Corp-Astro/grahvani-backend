...
router.post('/house-significations', kpPlanetsCuspsController.getKpHouseSignifications.bind(kpPlanetsCuspsController));
router.post('/planet-significators', kpPlanetsCuspsController.getKpPlanetSignificators.bind(kpPlanetsCuspsController));
router.post('/interlinks', kpPlanetsCuspsController.getKpInterlinks.bind(kpPlanetsCuspsController));
router.post('/interlinks-advanced', kpPlanetsCuspsController.getKpAdvancedInterlinks.bind(kpPlanetsCuspsController));
router.post('/interlinks-sl', kpPlanetsCuspsController.getKpInterlinksSL.bind(kpPlanetsCuspsController));
router.post('/nakshatra-nadi', kpPlanetsCuspsController.getKpNakshatraNadi.bind(kpPlanetsCuspsController));
