...
router.post(
  "/sudarshan-chakra",
  chartController.getSudarshanChakra.bind(chartController),
);
...
router.post(
  "/divisional/:type",
  chartController.getDivisionalChart.bind(chartController),
);
...
router.post(
  "/panchanga/:type?",
  chartController.getPanchanga.bind(chartController),
);
router.post(
  "/special/:type",
  chartController.getSpecialChart.bind(chartController),
);
...
router.post(
  "/ashtakavarga",
  chartController.getAshtakavarga.bind(chartController),
);
router.post(
  "/sarva-ashtakavarga",
  chartController.getSarvaAshtakavarga.bind(chartController),
);
router.post(
  "/shodasha-varga",
  chartController.getShodashaVarga.bind(chartController),
);
router.post(
...
router.post(
  "/dasha/vimshottari",
  dashaController.getVimshottariDasha.bind(dashaController),
);
router.post(
  "/dasha/prana",
  dashaController.getPranaDasha.bind(dashaController),
);
router.post(
  "/dasha/other",
  dashaController.getOtherDasha.bind(dashaController),
);
...
router.post(
  "/kp/planets-cusps",
  kpController.getPlanetsCusps.bind(kpController),
);
router.post(
  "/kp/ruling-planets",
  kpController.getRulingPlanets.bind(kpController),
);
router.post(
  "/kp/bhava-details",
  kpController.getBhavaDetails.bind(kpController),
);
router.post(
  "/kp/significations",
  kpController.getSignifications.bind(kpController),
);
