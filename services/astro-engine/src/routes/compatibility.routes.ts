...
router.post('/western/synastry', compatibilityController.getWesternSynastry.bind(compatibilityController));
router.post('/western/composite', compatibilityController.getWesternComposite.bind(compatibilityController));
router.post('/western/progressed', compatibilityController.getWesternProgressed.bind(compatibilityController));
